        ...
        <div className='bg-obi'>
            <div className='flex flex-col items-center justify-center my-4 md:my-6 lg:my-8 w-full'>
                <Fade cascade damping={0.5}>
                    <h2 className='text-xl md:text-2xl lg:text-4xl text-white font-bold font-playfairDisplay mb-4 md:mb-6 lg:mb-8'>Dependable and Trustworthy Visa</h2>
                    <p className='text-xs md:text-base lg:text-xl text-gray-200 font-semibold'>Our team of seasoned professionals understands the complexities of immigration laws and visa procedures.</p>
                </Fade>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div className="card card-border bg-base-100 dark:bg-gray-800 w-96 lg:w-lg">
