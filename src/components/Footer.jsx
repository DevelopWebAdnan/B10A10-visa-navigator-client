        ...
        <div>
            <footer className="footer sm:footer-horizontal bg-base-100 text-base-content p-10">
                <aside className="items-center">
                    <h3>
                        <a href="/" className="text-lg md:text-xl lg:text-2xl font-extrabold font-playfairDisplay">VISA NAVIGATOR</a>
                    </h3>
                    <br />
                    <h6 className="footer-title">Contact Us</h6>
                    <p><span className="font-semibold">Phone:</span> + 880 1234567890</p>
                    <p><span className="font-semibold">Email:</span> visa@navigator.info</p>
